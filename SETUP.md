...
$token = (Invoke-RestMethod -Uri "https://localhost:8843/realms/nest/protocol/openid-connect/token" -Method POST -Body @{grant_type="password"; client_id="nest-client"; username="admin"; password="CHANGE_ME_DEV_PASSWORD"} -SkipCertificateCheck).access_token
...
| user     | CHANGE_ME_DEV_PASSWORD | Benutzer |
